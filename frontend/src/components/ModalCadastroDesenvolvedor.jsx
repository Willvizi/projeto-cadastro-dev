...
const ModalCadastroDesenvolvedor = ({ open, onClose, onSave, niveis, loadingNiveis }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        setSalvando(true);
        try {
            const resultado = await onSave(dadosForm);
            if (resultado) {
                onClose();
            }
        } finally {
...
export default ModalCadastroDesenvolvedor;
